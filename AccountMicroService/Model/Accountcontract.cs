...
namespace AccountMicroService.Model
{
    public partial class Accountcontract
    {
        public Accountcontract()
        {
            ...
            InverseComissionaccountpkNavigation = new HashSet<Accountcontract>();
            InverseLinckedaccountpkNavigation = new HashSet<Accountcontract>();
            InversePendingaccountpkNavigation = new HashSet<Accountcontract>();
            InverseTechnicalaccountpkNavigation = new HashSet<Accountcontract>();
            Receivedbills = new HashSet<Receivedbill>();
            Recvplvs = new HashSet<Recvplv>();
        }
        ...
        public string? Smoothingprincipalcode { get; set; }
        ...
        public virtual ICollection<Accountcontract> InverseComissionaccountpkNavigation { get; set; }
        public virtual ICollection<Accountcontract> InverseLinckedaccountpkNavigation { get; set; }
        public virtual ICollection<Accountcontract> InversePendingaccountpkNavigation { get; set; }
        public virtual ICollection<Accountcontract> InverseTechnicalaccountpkNavigation { get; set; }
        public virtual ICollection<Receivedbill> Receivedbills { get; set; }
        public virtual ICollection<Recvplv> Recvplvs { get; set; }
    }
}
